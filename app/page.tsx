                ...
                <div key={test._id} className="rounded-3xl border border-gray-200 bg-gray-50 p-6 shadow-sm">
                  ...
                  {session && (
                    <div className="mt-4 flex flex-wrap gap-2">
                      ...
                      <Link
                        href={`/tests/${test._id}/crossword`}
                        className="inline-flex rounded-2xl bg-orange-600 px-4 py-2 text-sm font-medium text-white hover:bg-orange-700"
                      >
                        Crossword Puzzle
                      </Link>
                      <Link
                        href={`/tests/${test._id}/word-search`}
                        className="inline-flex rounded-2xl bg-lime-600 px-4 py-2 text-sm font-medium text-white hover:bg-lime-700"
                      >
                        Word Search
                      </Link>
                      <Link
